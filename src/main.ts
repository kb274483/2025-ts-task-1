...
export const cart: {sku:string, name:string, qty:number, price:number , potColor?:string}[] /* TODO: 陣列包物件的型別定義 > */ = [
...
export type BasicPlant = { id: number; name: string; price: number }  /* TODO: { id: 型別; name: 型別; price: 型別 } */
export type StockInfo = { sku: string; quantity: number }/* TODO: { sku: 型別; quantity: 型別 } */ 
...
// 目標：理解介面擴充多重介面的寫法。
export interface Price { price: number ,currency: string  } { /* TODO: price: 型別; currency:"TWD"|"USD" */ }
export interface Shippable  { weightKg: number , shipFrom: string  } { /* TODO: weightKg: 型別; shipFrom: 型別 */ }
...
export const publicPlant: CartPlant & PublicPlant = { id: 101, name: "琴葉榕", price: 2500, currency: "TWD" };
...
*/
export function submitProduct <T extends "create" | "update">(
  type: T ,
